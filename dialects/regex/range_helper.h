...
template<class LogF>
std::vector<std::pair<nat_t, nat_t>> merge_ranges(const std::vector<std::pair<nat_t, nat_t>>& old_ranges, LogF&& log) {
...
// precondition: ranges are sorted by increasing lower bound
inline std::vector<std::pair<nat_t, nat_t>> merge_ranges(const std::vector<std::pair<nat_t, nat_t>>& old_ranges) {
