...
TEST(Zip, fold) {
    ...
    std::istringstream iss(
        ".plugin fun;"
        ".plugin core;"
        ".let a = ((0:%core.I32, 1:%core.I32,  2:%core.I32), ( 3:%core.I32,  4:%core.I32,  5:%core.I32));"
        ".let b = ((6:%core.I32, 7:%core.I32,  8:%core.I32), ( 9:%core.I32, 10:%core.I32, 11:%core.I32));"
        ".let c = ((6:%core.I32, 8:%core.I32, 10:%core.I32), (12:%core.I32, 14:%core.I32, 16:%core.I32));"
        ".let r = %fun.zip (2, (2, 3), 2, ‹2; %core.I32›, 1, %core.I32) (%core.wrap.add 0) (a, b);");
    parser.import(iss);
