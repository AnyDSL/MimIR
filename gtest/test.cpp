...
TEST(Check, alpha) {
    ...
    auto check = [](Ref l1, Ref l2, bool infer_res, bool non_infer_res) {
        EXPECT_EQ(Check::alpha<Check::Beta>(l1, l2), infer_res);
        EXPECT_EQ(Check::alpha<Check::Beta>(l2, l1), infer_res);
        EXPECT_EQ(Check::alpha<Check::Test>(l1, l2), non_infer_res);
        EXPECT_EQ(Check::alpha<Check::Test>(l2, l1), non_infer_res);
    };
