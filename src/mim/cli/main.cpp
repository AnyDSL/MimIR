...
int main(int argc, char** argv) {
    ...
    try {
        static const auto version = "mim command-line utility version " THORIN_VER "\n";
        ...
        auto cli = lyra::cli()
            ...
            | lyra::opt(output[Thorin], "file"                )["-o"]["--output-mim"         ]("Emits the Thorin program again.")
            ...
            | lyra::opt(flags.scalarize_threshold, "threshold")      ["--scalarize-threshold"   ]("Thorin will not scalarize tuples/packs/sigmas/arrays with a number of elements greater than or equal this threshold.")
#ifdef THORIN_ENABLE_CHECKS
