...
struct Regex2NfaConverter {
    ...
    convert(const Def* regex, automaton::NFANode* start, automaton::NFANode* end, automaton::NFANode* error = nullptr) {
        ...
        } else if (auto plus = mim::test(quant::plus, regex)) {
