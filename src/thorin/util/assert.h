...
[[noreturn]] inline __attribute__((always_inline)) void unreachable([[maybe_unused]] const char* s = {}) { assert(false && s); __builtin_unreachable(); }
#elif defined(_MSC_VER) // MSVC
[[noreturn]] __forceinline void unreachable([[maybe_unused]] const char* s = {}) { assert(false && s); __assume(false); }
#else                   // ???
